...
func newPostLike(db *gorm.DB, opts ...gen.DOOption) postLike {
	...
	_postLike.StudentID = field.NewInt64(tableName, "student_id")
	_postLike.Status = field.NewInt32(tableName, "status")
...
type postLike struct {
	postLikeDo postLikeDo

	ALL       field.Asterisk
	ID        field.Int64
	PostID    field.Int64
	StudentID field.Int64 // 学生ID
	Status    field.Int32 // 1已点赞 0已取消
...
func (p *postLike) updateTableName(table string) *postLike {
	...
	p.StudentID = field.NewInt64(table, "student_id")
...
func (p *postLike) WithContext(ctx context.Context) IPostLikeDo { return p.postLikeDo.WithContext(ctx) }

func (p postLike) TableName() string { return p.postLikeDo.TableName() }

func (p postLike) Alias() string { return p.postLikeDo.Alias() }

func (p postLike) Columns(cols ...field.Expr) gen.Columns { return p.postLikeDo.Columns(cols...) }
